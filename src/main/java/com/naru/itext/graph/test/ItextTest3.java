...
public class ItextTest3 {
	...
	public static void main(String[] args) throws IOException {
		...
		String graphTitle = "Line Graph";
		String categoryAxisLabel = "category title";
		String valueAxisLabel = "value title";
		PlotOrientation orientation = PlotOrientation.VERTICAL;
		Boolean legendFlag = false;
		Boolean tooltipsFlag = true;
		Boolean urlsFlag = false;
		
		JFreeChart jChart = ChartFactory.createLineChart(graphTitle, categoryAxisLabel, valueAxisLabel, dataset, orientation, legendFlag, tooltipsFlag, urlsFlag);
		...
		try {
			...
			Graphics2D g2 = new PdfGraphics2D(templete, 400, 400);
